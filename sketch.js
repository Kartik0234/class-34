...
var button,button2,button3,blower,blower_img;
var bunny;
var blink,eat,sad;
var mute_btn;
...
var e_star,star_1,star_2,star_display;
var star_count=0;
...
function preload()
{
  ...
  e_star = loadAnimation("empty.png");
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   blower.position(255,300);
   blower.size(100,100);
   blower.mouseClicked(airBlow);

   star1 = createSprite(300,110,20,20)
   star1.addImage(star_img)
   star1.scale=0.02
  
   star2 = createSprite(30,280,20,20)
   ...
   star_display = createSprite(60,20,20,20)
   star_display.addAnimation("empty",e_star)
   star_display.addAnimation("one_star",star_1)
   star_display.addAnimation("two_star",star_2)
...
Body.applyForce(fruit,fruit.position,{x:0,y:-0.03})
air.play()
